                  ...
                  {[
                    {
                      ...
                      text: "Our interactive map shows you exactly where to find the parts you need.",
                    },
                    {
                      title: "Compare prices",
                      text: "Compare prices across multiple vendors to get the best deal on the parts you need.",
                    },
                    {
                      title: "Save your vehicles",
                      text: "Save your vehicles to quickly find compatible parts whenever you need them.",
                    },
                  ].map((item, idx) => (
